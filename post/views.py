...
from rest_framework import generics  # Add this import at the top
...
class PostView(viewsets.ModelViewSet):
    ...
    # Fix regex warning in slug pattern:
...
class PostDetail(generics.RetrieveUpdateDestroyAPIView):
    """
    SubThread API endpoint that allows single post to be viewed, edited or deleted
    """
    def get_object(self):
        queryset = self.filter_queryset(self.get_queryset())
